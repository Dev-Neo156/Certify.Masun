...
import { termsOfServiceHTML } from '@/lib/legalContent';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Terms of Service | MASUN Certificate Portal',
  description: 'Terms of Service and Website Content License for the MASUN Certificate Verification Portal by Masun Technology.',
};
